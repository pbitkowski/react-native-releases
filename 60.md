...
- [iOS] [Changed] - There seems to be a potential race condition during reloading that could cause "double registration" of modules. This should be mostly harmless, so downgrade to warning for the message instead of redboxing. ([17082d9](https://github.com/facebook/react-native/commit/17082d9) by [@fkgozali](https://github.com/fkgozali))
...
- [General] [Fixed] - Removed designated initializers in `ShadowNodeTest`, `ComponentDescriptorTest`, and `RootShadowNode` ([2c01259](https://github.com/facebook/react-native/commit/2c01259), [b30b103](https://github.com/facebook/react-native/commit/b30b103), [ 74870d7](https://github.com/facebook/react-native/commit/74870d7)  by [@empyrical](https://github.com/empyrical))
